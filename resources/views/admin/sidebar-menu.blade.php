<ul>
    ...
    <li>
        <x-nav-sidebar-link :href="route('events.index')" :active="request()->routeIs('events.index')">{{ __('Events') }}</x-nav-sidebar-link>
    </li>
    <li>
        <x-nav-sidebar-link :href="route('events.create')" :active="request()->routeIs('events.create')">- {{ __('Add new event') }}</x-nav-sidebar-link>
    </li>
    <li>
