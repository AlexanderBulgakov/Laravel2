<x-app-layout>
    ...
    <div class="p-4 flex justify-end border-b">
        <x-button-link-edit :href="route('categories.create')">{{ __('Create') }}</x-button-link-edit>
    </div>
                ...
                @foreach($categories as $category)
                    <tr class="border-b border-gray-300">
                        ...
                        <td class="py-4 text-right">
                            <x-button-link-cancel :href="route('categories.show', $category->slug)">{{ __('Info') }}</x-button-link-cancel>
                        </td>
                    </tr>
                @endforeach
            </tbody>
